...
int main(void){
	...
	for (i = 0; i < (sizeof(buf) / sizeof(buf[0])); i += 2) {
		...
		//printf("input = '%s'\ndigest: 0x%s\nresult: 0x", buf[i], buf[i + 1]);
		for (j = 0; j < SHA256_BYTES; j++){
			sprintf(outputStr,"%2.2x%2.2x%2.2x%2.2x%2.2x%2.2x%2.2x%2.2x%2.2x%2.2x%2.2x%2.2x%2.2x%2.2x%2.2x%2.2x%2.2x%2.2x%2.2x%2.2x%2.2x%2.2x%2.2x%2.2x%2.2x%2.2x%2.2x%2.2x%2.2x%2.2x%2.2x%2.2x",hash[0],hash[1],hash[2],hash[3],hash[4],hash[5],hash[6],hash[7],hash[8],hash[9],hash[10],hash[11],hash[12],hash[13],hash[14],hash[15],hash[16],hash[17],hash[18],hash[19],hash[20],hash[21],hash[22],hash[23],hash[24],hash[25],hash[26],hash[27],hash[28],hash[29],hash[30],hash[31]);
		}
